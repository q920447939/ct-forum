...
public class BeanUtilsCommon {
	...
	public static Object parseByType(Class<?> clazz, String str)
			throws ParseException, InstantiationException, IllegalAccessException, SecurityException,
