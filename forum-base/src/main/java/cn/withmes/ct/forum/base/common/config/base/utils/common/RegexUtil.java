...
import cn.withmes.ct.forum.base.common.config.base.utils.constant.RegexConstant;
...
public class RegexUtil {
    ...
    public static boolean validText(String text) {
        Pattern pattern = Pattern.compile(RegexConstant.VALID_TEXT);
        return pattern.matcher(text).matches();
     ...
     * @return
     */
    public static boolean privacyPhoneNo(String mobileNo) {
        Pattern pattern = Pattern.compile(RegexConstant.PRIVACY_PHONENO);
        return pattern.matcher(mobileNo).matches();
    }

    public static void main(String[] args) {
        System.out.println(RegexUtil.phoneNo("13706786143-12435"));
