package cn.withmes.ct.forum.base.common.redis;

import cn.withmes.ct.forum.base.common.utils.FastJsonUtil;
...
public class RedisCacheAspect {
     ...
     */
    @Pointcut("@annotation(com.withmes.spike.common.redis.RedisCache)")
     ...
     */
    @Pointcut("@annotation(com.withmes.spike.common.redis.RedisEvict)")
    ...
    public Object cache(ProceedingJoinPoint joinPoint) {
        ...
        Object result = null;
        try {
            if (null == value ||  -1 !=value.indexOf("4")) {
                if (logger.isInfoEnabled()) {
                    logger.info("缓存未命中");
                }
