...
package com.withmes.spike.common.utils;
...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("generator/template/Mapper.mybatis.vm");
...
/**
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("Mapper.mybatis.vm")){
			return "main" + File.separator + "resources" +  File.separator + "mapper"
					+ File.separator + className + "Mapper.mybatis";
		}
