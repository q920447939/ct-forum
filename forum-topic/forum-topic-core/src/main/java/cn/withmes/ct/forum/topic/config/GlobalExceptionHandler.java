...
import cn.withmes.ct.forum.base.common.error.BasicException;
import cn.withmes.ct.forum.base.common.error.ExceptionEntity;
...
/**
    ...
    private ModelAndView determineOutput(HttpServletRequest request, HttpServletResponse response, ExceptionEntity entity) {
        if (!(
            ...
            try {
                ResponseData<JSONObject> data = ResponseData.builder(JSONObject.parseObject(JSON.toJSONString(entity)), ResultCode.FAIL);
